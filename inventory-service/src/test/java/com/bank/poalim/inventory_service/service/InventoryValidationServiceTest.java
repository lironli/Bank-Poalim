...
//    @BeforeEach
//    void setUp() {
//        inventoryValidationService = new InventoryValidationService(productCatalogService);
//    }
//
//    @Test
...
//
//        // When
//        OrderValidationResult result = inventoryValidationService.validateOrder(orderId, items);
//
//        // Then
...
//        assertThat(result.getIssues().get(0).getType()).isEqualTo(OrderValidationResult.ValidationIssueType.INSUFFICIENT_QUANTITY);
//    }
//
//    @Test
...
//        assertThat(result.getIssues().get(0).getType()).isEqualTo(OrderValidationResult.ValidationIssueType.EXPIRED_PRODUCT);
//    }
//
//    @Test
...
//        assertThat(result.getIssues().get(0).getType()).isEqualTo(OrderValidationResult.ValidationIssueType.PRODUCT_NOT_FOUND);
//    }
//
//    @Test
...
//        List<OrderValidationResult.ValidatedItem> validatedItems = Arrays.asList(
//                OrderValidationResult.ValidatedItem.builder()
//                        .productId("P1001")
//                        .requestedQuantity(5)
...
//        );
//
//        OrderValidationResult validationResult = OrderValidationResult.builder()
//                .orderId(orderId)
//                .approved(true)
